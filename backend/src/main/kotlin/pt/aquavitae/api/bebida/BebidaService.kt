...
class BebidaService(
    ...
    fun search(filtro: BebidaFiltro, pageable: Pageable, utilizador: Utilizador?): Page<BebidaSummaryDto> {
    ...
    fun sugeridas(utilizador: Utilizador, pageable: Pageable): Page<BebidaSummaryDto> {
